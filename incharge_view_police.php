...
<head>
     ...
     if(isset($_POST['s2']))
    {
        ...
        {
            $pid=$_POST['pid'];
            $res="CREATE TRIGGER Sqltrig BEFORE DELETE ON police
            FOR EACH ROW BEGIN
            UPDATE complaint
            SET complaint.p_id = 'Null'
            AND complaint.inc_status = 'Unassigned'
            WHERE complaint.p_id = police.p_id
            END;";
  ...
  <div class="container">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="incharge_assign_case.php">Assign Cases</a></li>
