...
if(isset($_POST['s'])){
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST"){
       ...
       // $password=md5($u_pass);
       $resq="CREATE TRIGGER Sqltrig BEFORE INSERT ON user FOR EACH ROW SET NEW.u_name=UPPER(NEW.u_name);";
       $resa=mysqli_query($con,$resq);
	...
	<div class="center-container">
		 <div class="bg-agile">
          ...
          <p style="color:#dfdfdf">Password</p><input type="text"  name="password"  placeholder="6 Character minimum" pattern=".{6,}" id="pass" onfocusout="f1()"/>
					...
					<p style="color:#dfdfdf">Aadhar Number</p><input type="text"  name="aadhar_number" placeholder="Enter 12 Digit Aadhar no." minlength="12" maxlength="12" required pattern="[123456789][0-9]{11}" id="aadh" onfocusout="f1()"/>
