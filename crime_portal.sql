...
(1, 123214521452, 'Hebbal', 'Robbery', '2018-12-06', 'My Home has been Robbed.', 'Assigned', 'ChargeSheet Filed', 'b101');
...
('Manish Singh', 'a101', 'Murder', 'Whitefield', 'manish'),
('Alan John', 'b101', 'All', 'Hebbal', 'alan'),
('Ajay Ghosh', 'c101', 'Robbery', 'Hoskote', 'ajay'),
('Ashish', 'a102', 'All', 'Whitefield', 'ashish'),
('Jason Peter', 'c102', 'All', 'Hoskote', 'jason');
...
('shah@whitefield', 'Shahbaz', 'Whitefield', 'shahbaz'),
('shivam@hebbal', 'Shivam', 'Hebbal', 'shivam'),
('kevin@hoskote', 'Kevin', 'Hoskote', 'kevin');
...
('ADVAITH SANTHOSH', 'advaith@gmail.com', 'advaith', '127, Hoskote', 123214521453, 'Male', 9657465341),
('SATYANSH KUMAR', 'satyansh123@gmail.com', 'satyansh', '432, Hebbal', 123214521452, 'Male', 9854123654);
